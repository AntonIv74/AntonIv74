...
Меня зовут Антон, я тестировщик. Тут я хочу поделиться некоторыми вещами из своего портфолио, собранного во время обучения и волонтерской деятельности, участия в различных краудтестинг проектах. 
...
<div>
  ...
  <img src="[https://docs.testit.software/images/testit_logo_icon.png](https://docs.testit.software/images/testit_logo_icon_blue.png)" title="test-it" alt="test-it" width="40" height="40"/>&nbsp
